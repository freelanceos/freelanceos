...
export default function Download() {
  ...
  if (loading) {
    return (
      <div
        className="min-h-screen flex items-center justify-center bg-gray-50 font-arabic"
        dir="rtl"
      >
            ...
            {isValid ? (
              <div className="card">
                ...
                <p className="text-gray-600 mb-6">
                  يمكنك الآن تحميل كتاب "رحلة الانتشار - دليل النجاح على تيك
                  توك"
                </p>
                ...
                <div className="text-xs text-gray-500 mb-6">
                  <p>الملف بصيغة PDF • حجم الملف: 2 MB</p>
