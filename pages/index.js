...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>النجاح الرقمي - نحن نساعدك على النجاح في العالم الرقمي</title>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50 font-arabic" dir="rtl">
